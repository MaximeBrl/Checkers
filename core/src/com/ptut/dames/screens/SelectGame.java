...
public class SelectGame implements Screen {
    ...
    private void creationBouton(){
        ...
        final ImageButton param = new ImageButton(drawable);
    ...
    private void actionBouton(){
       ...
       public void clicked(InputEvent event, float x, float y) {
           ...
           Dialog dialog = new Dialog(" ", skinneon) {
...
"\n" +
"\n" +
"Les pions se déplacent vers l’avant en diagonale  d’une case si elle est libre si un pion adverse est sur la case, le pion le « mange ». Lorsqu’un pion se trouve en présence, diagonalement, d’une pièce adverse derrière laquelle se trouve une case libre, il doit obligatoirement sauter par-dessus cette pièce et occuper la case libre.\n" +
"S’il existe un pion à prendre après la prise d’un pion, il faut obligatoirement prendre ce pion puis du troisième s’il en existe un autre et etc.. Jusqu’à occuper la case vide. Donc il y ‘a un changement de position et direction possible à la suite de prises successives.  C’est une rafle.\n" +
"\n" +
"\n" +
"La dame peut aller vers l’avant et l’arrière sur les cases en diagonales, elle n’a pas de limitation de cases. Lorsqu’une dame se trouve en présence sur la même diagonale, directement ou à distance, d’une pièce adverse derrière laquelle se trouvent une ou plusieurs cases libres, elle doit obligatoirement passer par-dessus cette pièce et occuper, au choix, une des cases libres. \n" +
"S’il existe un pion à prendre après la prise d’un pion, il faut obligatoirement prendre ce pion puis du troisième s’il en existe un autre et etc.. Jusqu’à occuper la case vide. Donc il y ‘a un changement de position et direction possible à la suite de prises successives. C’est une rafle.\n" +
"\n" +
"\n" +
"/!\\ Pendant une rafle, il faut manger le plus de pions possibles. Si par exemple, on a la possibilité de manger trois dames ou quatres pions simples, il faut manger les quatres simples.\n" +
" \n" +
"But : «Manger» tous les pions adverses en passant au-dessus d’un pion adverse et indirectement atteindre la dernière rangée avec un pion pour obtenir une  dame et bénéficier d’avantages.\n" +
"\n" +
"\n" +
"Enlever les pions du damier : Après avoir mangé un pion, il est possible de l’enlever du jeu. Néanmoins, s’il existe une rafle, on doit attendre la fin de cette rafle avant d’enlever tous les pions. Il est possible par exemple pour une dame dans une rafle de passer plusieurs fois sur la même case mais il est interdit de passer deux fois sur un pion déjà raflé.\n" +
"\n" +
"\n" +
...
"\n" +
"\n" +
"Un joueur sélectionne un pion en cliquant dessus. Les pions disponibles sont en surbrillance. Ce pion passe en surbrillance ainsi que les cases en diagonale où il peut aller (la diagonale de droite et de gauche). Néanmoins, si un pion se situe à proximité, le joueur est dans l’obligation de prendre le pion .\n" +
